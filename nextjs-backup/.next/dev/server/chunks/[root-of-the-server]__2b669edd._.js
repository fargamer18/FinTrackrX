...
"[project]/app/api/admin/seed-user/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`CREATE EXTENSION IF NOT EXISTS "pgcrypto";`);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])(`CREATE TABLE IF NOT EXISTS users (
      ...
      updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP
        ...
        const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('SELECT id FROM users WHERE email = $1', [
            email
        ]);
        if (res.rowCount && res.rowCount > 0) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('UPDATE users SET password_hash = $1, name = $2, updated_at = CURRENT_TIMESTAMP WHERE email = $3', [
                hashed,
                name,
                email
            ]);
            ...
            const ins = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["query"])('INSERT INTO users (email, name, password_hash, is_verified) VALUES ($1, $2, $3, true) RETURNING id', [
                email,
                name,
                hashed
            ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2b669edd._.js.map