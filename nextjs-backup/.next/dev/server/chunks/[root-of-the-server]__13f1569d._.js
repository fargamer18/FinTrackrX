...
"[project]/lib/accounts.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getUserAccounts(userId) {
    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["safeQuery"])('SELECT id, user_id, name, type, balance, currency, is_active, created_at, updated_at FROM accounts WHERE user_id = $1 ORDER BY created_at DESC', [
        userId
    ]);
    return res.rows;
}
async function updateAccount(userId, accountId, partial) {
    const fields = [];
    const values = [];
    let idx = 1;
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["safeQuery"])(sql, values);
}
async function createAccount(userId, data) {
    const { name, type } = data;
    const currency = (data.currency || 'INR').toUpperCase();
    const balance = data.balance ?? 0;
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["safeQuery"])(`INSERT INTO accounts (user_id, name, type, currency, balance)
     VALUES ($1, $2, $3, $4, $5)`, [
        userId,
        name,
        type,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$accounts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/accounts.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__,
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$accounts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$accounts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
async function GET(req) {
    try {
        ...
        const accounts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$accounts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUserAccounts"])(userId);
...
async function PUT(req) {
    try {
        ...
        if (!accountId) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: 'accountId required'
        }, {
            status: 400
        });
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$accounts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateAccount"])(userId, accountId, {
            name,
            currency,
            is_active
        });
...
async function POST(req) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$accounts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAccount"])(userId, {
            name,
            type,
            currency,
            balance
...
//# sourceMappingURL=%5Broot-of-the-server%5D__13f1569d._.js.map