...
"[project]/app/api/security/2fa/setup/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const secret = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$totp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["randomBase32"])(20);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["safeQuery"])('UPDATE users SET twofa_secret = $1, twofa_enabled = false, updated_at = CURRENT_TIMESTAMP WHERE id = $2', [
            secret,
            user.id
        ]);
        const url = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$totp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["otpauthURL"])({
            issuer: 'FinTrackrX',
            label: user.email,
            secret
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
            error: e?.message || 'Failed to create 2FA secret'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2f921132._.js.map