...
function totp(secretBase32, time = Date.now(), step = 30, digits = 6) {
    ...
    const hmac = __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].createHmac('sha1', key).update(buffer).digest();
    const offset = hmac[hmac.length - 1] & 0x0f;
    const code = (hmac[offset] & 0x7f) << 24 | (hmac[offset + 1] & 0xff) << 16 | (hmac[offset + 2] & 0xff) << 8 | hmac[offset + 3] & 0xff;
    const otp = (code % Math.pow(10, digits)).toString().padStart(digits, '0');
    return otp;
}
function verifyTotp(token, secretBase32, window = 1, step = 30, digits = 6) {
    const now = Date.now();
...
function otpauthURL({ issuer, label, secret }) {
...
async function ensureUsersTable() {
    ...
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["safeQuery"])('CREATE EXTENSION IF NOT EXISTS "pgcrypto"');
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["safeQuery"])(`CREATE TABLE IF NOT EXISTS users (
...
async function POST(req) {
    try {
        ...
        // Get user
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].getUserByEmail(email.toLowerCase());
        if (!user) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        // Verify password
        const isValid = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auth"].verifyPassword(password, user.password_hash);
        if (!isValid) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Invalid credentials'
            }, {
        ...
        if (user.twofa_enabled) {
            ...
            const row = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["safeQuery"])('SELECT twofa_secret FROM users WHERE id = $1', [
                user.id
            ]);
            ...
            if (!secret) {
                ...
                if (!totp) {
                    ...
                    const mfaToken = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auth"].createMfaToken({
                        userId: user.id,
                        email: user.email
                    });
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ...
                const ok = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$totp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyTotp"])(String(totp), secret);
                if (!ok) {
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        // Update last login
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].updateLastLogin(user.id);
        // Create JWT token
...
//# sourceMappingURL=%5Broot-of-the-server%5D__af283086._.js.map