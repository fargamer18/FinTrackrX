...
"[project]/app/api/ai/health/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    try {
        ...
        const topCategories = Object.entries(categoryTotals).sort((a, b)=>b[1] - a[1]).slice(0, 6).map(([k, v])=>`${k} = ₹${v.toLocaleString()}`).join('\n');
...
Return ONLY valid JSON.`;
        ...
        if (!response.ok) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                score: heuristicScore,
                summary: 'Fallback heuristic applied due to AI error.',
                source: 'fallback'
            });
        }
        ...
        try {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                score: heuristicScore,
                summary: 'AI response unparsable; heuristic used.',
                source: 'fallback'
            });
        }
        ...
        if (financialData) {
            if (financialData.savingsRate >= 30) fallbackScore += 30;
            else if (financialData.savingsRate >= 20) fallbackScore += 25;
            else if (financialData.savingsRate >= 10) fallbackScore += 15;
            else if (financialData.savingsRate > 0) fallbackScore += 5;
            if (financialData.expenseRatio <= 50) fallbackScore += 20;
            else if (financialData.expenseRatio <= 70) fallbackScore += 10;
            fallbackScore = Math.min(100, Math.max(0, fallbackScore));
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            score: fallbackScore,
            summary: 'Unexpected error. Heuristic score provided.',
            source: 'fallback'
        });
    }
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__97067ccf._.js.map