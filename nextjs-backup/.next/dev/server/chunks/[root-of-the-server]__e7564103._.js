...
async function POST(req) {
    try {
        ...
        const resetToken = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auth"].generateToken();
        const expiresAt = new Date(Date.now() + 60 * 60 * 1000); // 1 hour
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].createVerificationToken(user.id, resetToken, expiresAt);
        // Send reset email
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$email$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["emailService"].sendPasswordResetEmail(email, user.name, resetToken);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            message: 'If an account exists with that email, a password reset link has been sent.'
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e7564103._.js.map