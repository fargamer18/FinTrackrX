...
"[project]/components/MuiThemeProviderCustom.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MuiThemeProviderCustom({ children }) {
    ...
    const [{ cache, flush }] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "MuiThemeProviderCustom.useState": ()=>{
            ...
            const wrappedInsert = {
                "MuiThemeProviderCustom.useState.wrappedInsert": (...args)=>{
            ...
            }["MuiThemeProviderCustom.useState.wrappedInsert"];
            // @ts-ignore assign wrapped insert
            cache.insert = wrappedInsert;
            const flush = {
                "MuiThemeProviderCustom.useState.flush": ()=>{
                    const prev = inserted;
                    inserted = [];
                    return prev;
                }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useServerInsertedHTML"])({
        "MuiThemeProviderCustom.useServerInsertedHTML": ()=>{
            const names = flush();
...
_s(MuiThemeProviderCustom, "01fFcPysYPtMirIQogoCSPcRaek=", false, function() {
    return [
...
_c = MuiThemeProviderCustom;
var _c;
__turbopack_context__.k.register(_c, "MuiThemeProviderCustom");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=components_0266878f._.js.map